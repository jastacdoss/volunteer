...
export const SERVE_TEAMS: ServeTeam[] = [
  ...
  },
  {
    ...
    icon: 'prayer',
    leader: 'John Pratt',
    schedule: 'Sunday mornings & throughout the week',
    commitment: 'Flexible',
    matrixKey: 'prayer',
  },
  {
    ...
    icon: 'water',
    leader: 'Tami Sanders',
    schedule: 'As needed (baptism Sundays)',
    commitment: 'Flexible',
    matrixKey: 'baptism',
  },
  {
  ...
  // Kids Ministry Teams
  {
    ...
    schedule: 'Sunday mornings',
    commitment: '1-2 hours weekly (rotating schedule available)',
    matrixKey: 'kids',
  },
  {
    id: 'five6',
  ...
  {
    id: 'student-bible-study',
    name: 'Thursday Night Bible Study',
    description: 'Help high school students build scripture study skills.',
    longDescription: 'High school students build scripture study skills and discuss culture-relevant topics. Leaders help facilitate discussions and mentor students as they dig deeper into God\'s Word and apply it to their daily lives.',
    category: 'student-ministry',
    icon: 'book',
    leader: 'Travis Eslinger',
